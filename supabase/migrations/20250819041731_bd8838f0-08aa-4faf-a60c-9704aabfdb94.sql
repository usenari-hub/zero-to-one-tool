-- Fix security definer view issue by recreating the view with proper ownership
-- and ensuring it's explicitly set as SECURITY INVOKER
...
-- Change ownership to supabase_admin to follow best practices
ALTER VIEW public.marketplace_listings OWNER TO supabase_admin;